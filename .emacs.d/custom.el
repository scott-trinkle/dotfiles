(custom-set-variables
	...
	(quote
	 (org-agenda-skip-entry-if
	  ...
	  (quote
       ...
       (org-agenda-files
	(quote
	 ("~/GoogleDrive/org/projects.org")))))
     ("o" "Someday TODOs"
      ((tags-todo "someday"
		  ((org-agenda-overriding-header "Actions To Do Someday")
		   (org-agenda-skip-function
		    (quote
		     (org-agenda-skip-entry-if
		      (quote scheduled)))))))
      ...
      ((agenda ""
       ...
       (todo "STARTED"
		...
		(org-agenda-skip-entry-if
		 (quote scheduled))))))
       (todo "WAITING"
	     ((org-agenda-overriding-header "Things I Am Waiting For")
	      (org-agenda-skip-function
	       (quote
		(org-agenda-skip-entry-if
		 (quote scheduled)))))))
 ...
 '(package-selected-packages
   (quote
    (org-alert pdf-tools org-pdfview pyenv-mode pyenv-mode-auto org-edna ac-octave auctex-latexmk auctex-lua auctex magit flycheck py-autopep8 notmuch emojify mu4e-alert xterm-color cl-lib fill-column-indicator elpy auto-complete)))
 '(preview-gs-options
   (quote
